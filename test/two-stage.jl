...
using ExaModels
import NLPModels
import NLPModels: obj, cons!, grad!, jac_coord!, hess_coord!, jac_structure!, hess_structure!
...
@testset "TwoStageExaModel" begin
    ...
    @testset "Warm start - zero iterations from optimal" begin
        ...
        v_sol = x_sol[recourse_var_indices(model1, 1):recourse_var_indices(model1, ns)[end]]
