...
function _exa_luksan_struct_model(backend, N; M = 1)
    ...
    @var(c, x, N, M; start = [luksan_vlcek_x0(i.i.i[1]) for i in data])
    @con(c, s, luksan_vlcek_con1(x, i.i.i[1], i.i.i[2]) for i in data[1:end-2,:])
    @con!(c, s, (i.i.i[1], i.i.i[2]) => luksan_vlcek_con2(x, i.i.i[1], i.i.i[2]) for i in data[1:end-2,:])
