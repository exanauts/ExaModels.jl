...
convert_array(d::Deferred, backend) = d
convert_array(d::Deferred, ::Nothing) = d
convert_array(p::ExaModels._DefProd2, backend) = p
convert_array(p::ExaModels._DefProd2, ::Nothing) = p
