...
@inline (v::ParameterNode{I})(i, x, ::Nothing) where {I<:AbstractNode} = 0
@inline (v::ParameterNode{I})(::Any, x, ::Nothing) where {I} = 0
@inline (v::ParameterNode{I})(::Identity, x, ::Nothing) where {I<:AbstractNode} = 0

@inline (v::ParSource)(i, x, θ) = i
@inline (v::ParIndexed{I,n})(i, x, θ) where {I,n} = @inbounds getfield(getfield(v, :inner)(i, x, θ), n)

(v::ParIndexed)(i::Identity, x, θ) = 0 # despecialized
(v::ParSource)(i::Identity, x, θ) = 0 # despecialized
