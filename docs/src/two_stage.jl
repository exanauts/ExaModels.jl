...
@add_variable(core, d; start = 1.0, lvar = 0.0, uvar = Inf, scenario = 0)  ## design variable d
...
@add_variable(core, v, ns, nv; start = 1.0, lvar = 0.0, uvar = Inf, scenario = [i for i=1:ns, j=1:nv])  ## recourse variables v
